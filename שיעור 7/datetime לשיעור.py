...
def game():
    ...
    if q == questions[0]:
        ...
        if a == d.strftime("%M") or a == d.strftime("%I"):
            print("you are correct you get 10 points")
            sum_points += 10
        else:
            print("wrong answer 5 points has take from you")
...
def hola_time(name):
    ...
    print(type(h1))
    if 6 <= h < 12:
        print("boker tova " + name + " boom boom boom")
    elif 12 <= h < 18:
        print("Good afternoon " + name + " boom boom boom")
    elif 18 <= h < 21:
        print("Good evening " + name + " boom boom boom")
    else:
        print("Good night " + name + " boom boom boom")